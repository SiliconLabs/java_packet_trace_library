 ...
 * structure for the integer that is the type. External callers, however, should
 * not assume this structure and should only use API methods for access
 * (isPacket(), isGroup(), etc.). Should you have a need to know something about
 * the type, ALWAYS add aditional API methods to this class, rather than assume
 * that the integer returned by value() has a meaning.
 *
...
public class EventType implements Comparable<EventType> {
  ...
  // STATIC ATTRIBUTES
  private static Map<String, EventType> storage = Collections.synchronizedMap(new HashMap<String, EventType>());
  private static List<EventType> groups = Collections.synchronizedList(new ArrayList<EventType>());
  ...
  public static final EventType fromDebugMessage(final DebugMessageType t) {
    ...
    if (et == null) {
      ...
      et = make(mask, CATEGORY_BACKCHANNEL, (short) t.value(), name, t.longDescription());
  ...
  public static final EventType UNKNOWN_DEBUG_MESSAGE = make(MASK_NONE,
                                                             CATEGORY_UNKNOWN,
                                                             (short) 0,
                                                             "Unknown",
                                                             "Unknown debug message event");

  public static final EventType UNKNOWN_TYPE = make(MASK_NONE,
                                                    CATEGORY_UNKNOWN,
                                                    (short) 1,
                                                    "Unknown",
                                                    "Unknown event type");
  ...
  public static final EventType TX_OWL = make(MASK_PACKET, CATEGORY_PACKET_SOURCE, (short) 4, "TxOWL", "OWL Tx packet");

  public static final EventType RX_OWL = make(MASK_PACKET, CATEGORY_PACKET_SOURCE, (short) 5, "RxOWL", "OWL Rx packet");
  ...
  public static final EventType DEBUG = make(0,
  ...
  // Simulated events
  public static final EventType SIMULATED_LOCATION = make(MASK_DONTSAVE,
                                                          CATEGORY_SIMULATED,
                                                          (short) 1,
                                                          "Location",
                                                          "Node location information");

  public static final EventType SIMULATED_TX = make(MASK_PACKET,
                                                    CATEGORY_SIMULATED,
                                                    (short) 2,
                                                    "Packet",
                                                    "Simulated packet");

  public static final EventType SIMULATED_RX = make(0, CATEGORY_SIMULATED, (short) 3, "Rx", "Simulated RX");

  // Defined group event types
  public static final EventType GROUP_GENERIC = mkGrp(MASK_GENERIC, "Transactn", "Generic Transaction");

  public static final EventType GROUP_MAC = mkGrp(MASK_GENERIC, "Mac", "15.4 MAC transaction");

  public static final EventType GROUP_UNICAST = mkGrp(MASK_NONE, "Unicast", "ZigBee unicast transaction");

  public static final EventType GROUP_BROADCAST = mkGrp(MASK_NONE, "Broadcast", "ZigBee broadcast transaction");

  public static final EventType GROUP_TRANSPORT_DGRAM = mkGrp(MASK_NONE, "Datagram", "ZigBee transport datagram");

  public static final EventType GROUP_APS = mkGrp(MASK_NONE, "APS", "ZigBee APS transaction");

  public static final EventType GROUP_ASSOCIATION = mkGrp(MASK_NONE, "Associate", "ZigBee association transaction");

  public static final EventType GROUP_ROUTE_DISCOVERY = mkGrp(MASK_NONE, "Route", "Route discovery transaction");

  public static final EventType GROUP_EMBER_NETWORK = mkGrp(MASK_NONE, "EmberNet", "EmberNet network transaction");

  // These are bootload thingies.
  public static final EventType GROUP_BOOTLOAD = mkGrp(MASK_NONE, "Bootload", "OTA Bootload Transaction");

  public static final EventType GROUP_BOOTLOAD_QUERY = mkGrp(MASK_NONE, "BootQry", "OTA Bootload Query Transaction");

  public static final EventType GROUP_BOOTLOAD_REQUEST = mkGrp(MASK_NONE,
                                                               "BootReq",
                                                               "OTA Bootload Request Transaction");

  public static final EventType GROUP_BOOTLOAD_XMODEM = mkGrp(MASK_NONE, "BootXMod", "OTA Bootload XModem Transaction");

  public static final EventType GROUP_NETWORK_REJOIN = mkGrp(MASK_NONE, "Rejoin", "Network Rejoin transaction");

  public static final EventType GROUP_ZIGBEE_UNICAST_COMMAND = mkGrp(MASK_NONE, "CmdUnicast", "ZigBee Unicast Command");

  public static final EventType GROUP_SKKE = mkGrp(MASK_NONE, "SKKE", "SKKE Protocol Negotiation");

  public static final EventType GROUP_ENTITY_AUTHENTICATION = mkGrp(MASK_NONE, "EA", "Entity Authentication");

  public static final EventType GROUP_ALARM = mkGrp(MASK_NONE, "Alarm", "ZigBee APS Alarm");

  public static final EventType GROUP_LEAVE = mkGrp(MASK_NONE, "Leave", "Leave Transaction");

  public static final EventType GROUP_ZIGBEE_BROADCAST_COMMAND = mkGrp(MASK_NONE,
                                                                       "CmdBcast",
                                                                       "ZigBee Broadcast Command");

  public static final EventType GROUP_IP = mkGrp(MASK_GENERIC, "IP", "IP Message");

  public static final EventType GROUP_FRAGMENT = mkGrp(MASK_GENERIC, "Reassembly", "Reassembled Fragments");

  public static final EventType GROUP_TCP = mkGrp(MASK_NONE, "TCP", "TCP Message");

  public static final EventType GROUP_UDP = mkGrp(MASK_NONE, "UDP", "UDP Message");

  public static final EventType GROUP_ZLL_COMMISSIONING = mkGrp(MASK_NONE, "ZllComm", "ZllCommissioning");

  public static final EventType GROUP_PANA = mkGrp(MASK_NONE, "Pana", "PANA session");

  public static final EventType GROUP_ICMP = mkGrp(MASK_NONE, "ICMPv6", "ICMPv6 Message");

  public static final EventType GROUP_DNS = mkGrp(MASK_NONE, "DNS", "DNS Message");

  public static final EventType GROUP_MUSTANG = mkGrp(MASK_NONE, "Mustang", "Mustang");

  public static final EventType GROUP_RF4CE_DISCOVERY = mkGrp(MASK_NONE, "Discovery", "RF4CE Discovery");

  public static final EventType GROUP_RF4CE_PAIRING = mkGrp(MASK_NONE, "Pairing", "RF4CE Pairing");

  public static final EventType GROUP_LATENCY = mkGrp(MASK_GENERIC, "Latency", "Latency");

  public static final EventType GROUP_OWL = mkGrp(MASK_NONE, "OWL", "One Way Link");

  public static final EventType GROUP_RF4CE_NETWORK = mkGrp(MASK_GENERIC, "Network", "RF4CE Network");

  public static final EventType GROUP_RF4CE_GDP = mkGrp(MASK_NONE, "GDP", "RF4CE GDP");

  public static final EventType GROUP_RF4CE_ZRC_1_X = mkGrp(MASK_NONE, "ZRC1.x", "ZigBee Remote Control 1.x");

  public static final EventType GROUP_RF4CE_ZRC_2_X = mkGrp(MASK_NONE, "ZRC2.x", "ZigBee Remote Control 2.x");

  public static final EventType GROUP_RF4CE_MSO = mkGrp(MASK_NONE, "MSO", "RF4CE MSO");

  public static final EventType GROUP_CONNECT_NETWORK = mkGrp(MASK_NONE, "ConctNet", "Connect Network");

  public static final EventType GROUP_BLE_ATTRIBUTES = mkGrp(MASK_NONE, "BleAttr", "BLE Attributes Protocol");

  public static final EventType GROUP_BLE_ATTRIBUTE_COMMANDS = mkGrp(MASK_NONE, "BleAttrCmd", "BLE Attribute Command");

  public static final EventType GROUP_BLE_ADVERTISEMENT = mkGrp(MASK_NONE, "BleAdv", "BLE Advertisement");

  public static final EventType GROUP_BLE_ADVERTISEMENT_EXT = mkGrp(MASK_NONE,
                                                                    "BleAdvExt",
                                                                    "BLE Advertisement Extensions");

  public static final EventType GROUP_BLE_LINKLAYER = mkGrp(MASK_NONE, "BleLl", "BLE Link Layer Control");

  public static final EventType GROUP_BLE_SMP = mkGrp(MASK_NONE, "BleSmp", "BLE Pairing");

  public static final EventType GROUP_BT_MESH_ADVERTISEMENT = mkGrp(MASK_NONE, "BtMeshAdv", "BT Mesh Advertisement");

  public static final EventType GROUP_BT_MESH_RELAY = mkGrp(MASK_NONE, "BtMeshRel", "BT Mesh Relay");

  public static final EventType GROUP_BT_MESH_LINK_ESTABLISHMENT = mkGrp(MASK_NONE,
                                                                         "BtMeshLink",
                                                                         "BT Mesh Link Establishment");

  public static final EventType GROUP_BT_MESH_PROVISIONING = mkGrp(MASK_NONE, "BtMeshProv", "BT Mesh Provisioning");

  public static final EventType GROUP_BT_MESH_ACCESS = mkGrp(MASK_NONE,
                                                             "BtMeshAcc",
                                                             "BT Mesh Access Message Transactions");

  public static final EventType GROUP_BT_MESH_SEGMENTATIONACK = mkGrp(MASK_NONE,
                                                                      "BtMeshSeg",
  ...
  public static final EventType CHANNEL_CHANGE = make(0,
  ...
  // Synthetic event types that are created as a result of user action
  // These stay in the cache and are seen by the user.
  public static final EventType NETWORK_CHANGE = make(0,
                                                      CATEGORY_SYNTHETIC_USER,
                                                      (short) 3,
                                                      "NetChange",
                                                      "Sniffer network change notification");

  public static final EventType BOOKMARK_PACKET = make(MASK_DONTSAVE,
                                                       CATEGORY_SYNTHETIC_USER,
                                                       (short) 4,
                                                       "Bookmark",
                                                       "Packet annotation");

  public static final EventType BOOKMARK_GROUP = make(MASK_DONTSAVE,
                                                      CATEGORY_SYNTHETIC_USER,
                                                      (short) 5,
                                                      "Bookmark",
                                                      "Transaction annotation");

  public static final EventType ADAPTER_INFO = make(0,
                                                    CATEGORY_SYNTHETIC_USER,
                                                    (short) 6,
                                                    "Adapter",
  ...
  public static final EventType GROUP_MARK = make(MASK_DONTSAVE,
                                                  CATEGORY_SYNTHETIC_SYSTEM,
                                                  (short) 1,
                                                  "GrpMark",
                                                  "Group marker");

  public static final EventType STREAM_STOP = make(MASK_DONTSAVE,
                                                   CATEGORY_SYNTHETIC_SYSTEM,
                                                   (short) 2,
                                                   "StopStream",
                                                   "Stream stopped");

  public static final EventType TIME_SHIFT = make(MASK_DONTSAVE,
                                                  CATEGORY_SYNTHETIC_SYSTEM,
                                                  (short) 3,
                                                  "TimeShift",
                                                  "Time shift performed");

  public static final EventType DECRYPTOR_TYPE = make(MASK_DONTSAVE,
                                                      CATEGORY_SYNTHETIC_SYSTEM,
                                                      (short) 4,
                                                      "Decryptor",
                                                      "Decryptor type detected");

  public static final EventType TIMER_TICK = make(MASK_DONTSAVE, CATEGORY_SYNTHETIC_SYSTEM, (short) 5, "Tick", "Tick");

  public static final EventType STACK_PROFILE = make(MASK_DONTSAVE,
                                                     CATEGORY_SYNTHETIC_SYSTEM,
                                                     (short) 6,
                                                     "StackPro",
                                                     "Stack profile changed");

  public static final EventType STREAM_CLEAR = make(MASK_DONTSAVE,
                                                    CATEGORY_SYNTHETIC_SYSTEM,
                                                    (short) 7,
                                                    "Clear",
                                                    "Stream Clear");

  public static final EventType CAPTURE_PROFILE = make(MASK_DONTSAVE,
                                                       CATEGORY_SYNTHETIC_SYSTEM,
                                                       (short) 8,
                                                       "CapturePro",
                                                       "Capture Profile");

  public static final EventType SEGMENT_START = make(MASK_DONTSAVE,
                                                     CATEGORY_SYNTHETIC_SYSTEM,
                                                     (short) 9,
                                                     "Segment",
                                                     "Segment Start");

  public static final EventType OUT_OF_SEQUENCE = make(MASK_DONTSAVE,
                                                       CATEGORY_SYNTHETIC_SYSTEM,
                                                       (short) 10,
                                                       "OutOfSeq",
                                                       "Message out of Sequence");

  public static final EventType TIME_SET = make(MASK_DONTSAVE,
                                                CATEGORY_SYNTHETIC_SYSTEM,
                                                (short) 11,
                                                "TimeSet",
  ...
  public static final EventType LOG_PACKET_NO_LENGTH = make(MASK_PACKET,
  ...
  public static final EventType LOG_PACKET_WITH_LENGTH = make(MASK_PACKET,
                                                              CATEGORY_FROM_OLD_LOG,
                                                              (short) 1,
                                                              "Packet",
  ...
  public static final EventType CAPTURE_PROBLEM = make(MASK_NONE,
                                                       CATEGORY_INSTRUMENTATION,
                                                       (short) 0,
                                                       "Error",
                                                       "Capture Errors");

  public static final EventType CAPTURE_INFO = make(MASK_NONE,
                                                    CATEGORY_INSTRUMENTATION,
                                                    (short) 1,
                                                    "Diagnostic",
                                                    "Capture Diagnostics");
  ...
  private static EventType mkGrp(final int mask, final String name, final String description) {
    return make(mask | MASK_DONTSAVE, CATEGORY_GROUP, nextGroupSubtype++, name, description);
  }
  ...
  private static EventType
    ...
    if (name.length() > MAX_NAME_LENGTH)
      throw new IllegalArgumentException("Event name " + name + " exceeds max length " + MAX_NAME_LENGTH);
    if (name.indexOf(' ') != -1)
  ...
  /**
   * This method can be used to retrieve the event type from a value. This will be
   * used by file reader/writers. May return null, but that means something is
   * seriously wrong. Probably file missmatch. If you use this anywhere else then
   * in persist/depersist mechanisms you are probably doing something VERY WRONG.
   */
  ...
  public boolean isAemSample() {
    return (isAem() && (this == SIMULATED_AEM_SAMPLE || this == fromDebugMessage(DebugMessageType.AEM_SAMPLE)));
  }

  /** Returns true if this type is aem counter */
  public boolean isAemCounter() {
    return (isAem() && (this == SIMULATED_AEM_COUNTER || this == fromDebugMessage(DebugMessageType.AEM_COUNTER)));
  }

  public boolean isTx() {
    return this == TX_2420 || this == TX_250 || this == SIMULATED_TX || this == TX_350 || this == TX_GENERIC
        || this == TX_PRO2 || this == TX_PRO2P || this == TX_OWL || this == TX_EFR;
  }

  public boolean isRx() {
    return this == RX_2420 || this == RX_250 || this == SIMULATED_RX || this == RX_350 || this == RX_GENERIC
        || this == RX_PRO2 || this == RX_PRO2P || this == RX_OWL || this == RX_EFR;
  }
  ...
  /**
   * Return true if the type is a generic type such as BROADCAST or UNICAST
   * 
   * @return boolean
   */
  ...
  /**
   * Returns true if this packet has no length byte. It will not validate whether
   * this event is a packet event at all, so this is up to you.
   */
  public boolean hasNoLengthByte() {
    return (this == LOG_PACKET_NO_LENGTH || this == SNIFFER_PACKET || this == SIMULATED_TX || this == IMPORTED_PCAP
        || this == IMPORTED_ZBOSS);
  }
  ...
  /**
   * Returns raw type. Caller should not assume any internal structure of this
   * number, or particular bit properties. If you use this anywhere else then
   * persist/depersist mechanism, you are most probably doing something WRONG! If
   * you want to check equality, use equals() method.
   */
  public int value() {
    return value;
  }
