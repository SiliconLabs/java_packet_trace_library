...
/**
 * Common line terminator enum for all supported line terminations. We need to
 * support different formats from the adapter, so this centralizes all the
 * line-terminator handling in ISD.
 * 
